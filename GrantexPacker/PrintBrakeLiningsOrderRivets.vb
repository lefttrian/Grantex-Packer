...
Public Class PrintBrakeLiningsOrderRivets
    ...
    Private Sub BLORDER_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ReportViewer1.LocalReport.ReportPath = "\\192.1.1.7\common\ΤΡΙΑΝΤΑΦΥΛΛΟΥ ΛΕΥΤΕΡΗΣ\Grantex Packer\Reports\BrakeLiningsOrderRivets.rdlc"
...
where ftrid=" + ftrid.ToString + " and substring(m.code,1,3) in ('101','104','118') group by ftrid,m.mnfid) b on b.ftrid=f.id
        ...
        Using COM As New SqlCommand(cmd, updconn)
            Using DT As New DataTable
                ...
                Me.DataTable3TableAdapter.Fill(Me.TESTFINALDataSet.DataTable3, ftrid)
    ...
    Private Sub ReportViewer1_PrintingBegin(sender As Object, e As ReportPrintEventArgs) Handles ReportViewer1.PrintingBegin
        Dim txt As String = "Εντολή Πριτσινιών, " + Form1.activeuser + ", " + DateTime.Now.ToString("yyyy/MM/dd HH:mm") + Environment.NewLine
        ...
        Using ut As New PackerUserTransaction
            ut.WriteEntry(Form1.activeuserid, 23, ftrid)
        End Using
    End Sub
End Class